...
interface FullDescription {
    sixth_section_second_content: any;
    sixth_section_first_content: any;
    sixth_section_heading: any;
    fifth_section_content_ending: any;
    fifth_section_content: any;
    fifth_section_heading: any;
    fourth_section_closing_content: any;
    ...
    second_section_closing_content: any;
...
export default function MtvssPage() {
  const filePath = path.join(process.cwd(), "public/data/treatments/mtvss.json");
      ...
      {treatment.fullDescription.map((section, idx) => {
        ...
        return (
          <div key={idx} className="mb-10">
            ...
            {section.second_section_closing_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-5">
                {section.second_section_closing_content}
              </p>
            )}
            ...
            {hasBullets && (
              <ul className="list-disc list-inside text-gray-700 text-xl md:text-2xl mb-15 space-y-2 marker:text-pink-500">
                ...
                {section.fourth_section_fifth_bullet && <li>{section.fourth_section_fifth_bullet}</li>}
              </ul>
            )}
            
            {section.fourth_section_closing_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-5">
                {section.fourth_section_closing_content}
              </p>
            )}
            ...
            {section.fifth_section_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-5">
                {section.fifth_section_content}
              </p>
            )}

            {section.fifth_section_content_ending && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-5">
                {section.fifth_section_content_ending}
              </p>
            )}
            ...
            {section.sixth_section_first_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-5">
                {section.sixth_section_first_content}
              </p>
            )}

            {section.sixth_section_second_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-5">
                {section.sixth_section_second_content}
              </p>
            )}
