  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      {treatment.fullDescription.map((section, idx) => {
        ...
        const hasBullets = section.fourth_section_first_bullet || section.fourth_section_second_bullet || section.fourth_section_third_bullet || section.fifth_section_first_bullet || section.fifth_section_second_bullet || section.fifth_section_third_bullet;
        ...
        return (
          <div key={idx} className="mb-10">
            ...
            {section.second_section_first_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-10">
                {section.second_section_first_content}
              </p>
            )}
            ...
            {section.second_section_second_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-10">
                {section.second_section_second_content}
              </p>
            )}

            {section.second_section_third_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-10">
                {section.second_section_third_content}
              </p>
            )}
            ...
            {section.fifth_section_first_content && (
              <p className="text-gray-700 text-2xl md:text-3xl whitespace-pre-line mb-5">
                {section.fifth_section_first_content}
              </p>
            )}
